	...
	product_categories_nova = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/shoes/fancy_heels = 3,
				/obj/item/clothing/shoes/fancy_heels/cc = 2,
				/obj/item/clothing/shoes/fancy_heels/syndi = 2,
				/obj/item/clothing/shoes/fancy_heels/wizard = 2,
				...
				/obj/item/clothing/shoes/fancy_heels/navyblue = 2,
				/obj/item/clothing/shoes/fancy_heels/white = 3,
				/obj/item/clothing/shoes/fancy_heels/darkblue = 2,
				/obj/item/clothing/shoes/fancy_heels/black = 3,
				/obj/item/clothing/shoes/fancy_heels/purple = 2,
				/obj/item/clothing/shoes/fancy_heels/grey = 3,
				/obj/item/clothing/shoes/fancy_heels/brown = 2,
				/obj/item/clothing/shoes/fancy_heels/orange = 2,
				/obj/item/clothing/shoes/fancy_heels/lightblue = 2,
				/obj/item/clothing/shoes/fancy_heels/green = 2,
				/obj/item/clothing/shoes/fancy_heels/darkgreen = 2,
				/obj/item/clothing/shoes/fancy_heels/teal = 2,
				/obj/item/clothing/shoes/fancy_heels/mutedblack = 2,
				/obj/item/clothing/shoes/fancy_heels/mutedblue = 2,
				/obj/item/clothing/shoes/fancy_heels/beige = 2,
				/obj/item/clothing/shoes/fancy_heels/darkgrey = 2,
			),
		),
