...
/obj/item/clothing/under/costume/playbunny
	icon = 'modular_nova/modules/bunny/icons/obj/clothing/under/costume.dmi'
	worn_icon = 'modular_nova/modules/bunny/icons/mob/clothing/under/bunnysuits.dmi'
	worn_icon_digi = 'modular_nova/modules/bunny/icons/mob/clothing/under/bunnysuits_digi.dmi'
...
/obj/item/clothing/under/rank/security/security_bunnysuit
	...
	icon = 'modular_nova/modules/bunny/icons/obj/clothing/under/security.dmi'
	worn_icon = 'modular_nova/modules/bunny/icons/mob/clothing/under/bunnysuits.dmi'
	worn_icon_digi = 'modular_nova/modules/bunny/icons/mob/clothing/under/bunnysuits_digi.dmi'
	body_parts_covered = CHEST|GROIN|LEGS
	alt_covers_chest = TRUE
